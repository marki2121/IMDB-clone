async function getBestMovies() {
  const require = await fetch(
    `https://api.themoviedb.org/3/movie/popular?api_key=eb44ee80df76c8e88bc09021aa1168dd&language=en-US&page=1`
  );
...
async function getBestMoviesType(type) {
  const require = await fetch(
    `https://api.themoviedb.org/3/movie/popular?api_key=eb44ee80df76c8e88bc09021aa1168dd&language=en-US&page=1&with_genres=${type}`
  );
  const data = await require.json();
...
async function getMovies(title) {
  const require = await fetch(
    `https://api.themoviedb.org/3/search/movie?api_key=eb44ee80df76c8e88bc09021aa1168dd&language=en-US&query=${title}&page=1&include_adult=false`
  );
  const data = await require.json();
...
async function getMoviesType(title, type) {
  const require = await fetch(
    `https://api.themoviedb.org/3/search/movie?api_key=eb44ee80df76c8e88bc09021aa1168dd&language=en-US&query=${title}&page=1&include_adult=false&with_genres=${type}`
  );
  const data = await require.json();
